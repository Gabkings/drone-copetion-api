...
class DroneSerializer(serializers.HyperlinkedModelSerializer):
    # Display the categoty name
    drone_category = serializers.SlugRelatedField(queryset=DroneCategory.objects.all(),slug_field='name')

    class Meta:
        model = Drone
        fields = (
        'url','name','drone_category','manufacturing_date','has_it_competed','inserted_timestamp'
        )
...
class CompetitionSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Competition
        fields = (
        'url','pk','distance_in_feet','distance_achivement_date','drone'
        )
...
class PilotSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model =  Pilot
        fields = (
        'url','name','gender','gender_description','race_count','inserted_timestamp','competitions'
        )

class PilotCompetionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Competition
        fields = (
        'url','pk','distance_in_feet','distance_achivement_date','pilot','drone'
        )
